...
import {getDaysAgoDate, getTodayDate, logout} from "@/utils/general";
  ...
  <Dialog v-model:visible="displayNoFunds" modal header="Saldo insuficiente" :style="{ width: '20rem' }"
    ...
    <AccordionTab header="Resultados">
      ...
      <template #option="slotProps">
        <div class="flex flex-column" style="height: 30px; " >
          <div class="flex"  >
          <div class="mr-4"><img alt="" :src="'/images/products/transparency/'+gameProducts[slotProps.option.id]?.logo" style="width:50px; height: auto;"/></div>
